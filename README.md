<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=10,20,30&height=150&section=header&text=Hello,%20DungNguyenUS%20👋&fontSize=40&animation=twinkling"/>

  <h1>🌌 Welcome to my tech universe!</h1>
  <h3>Computer Science Student | AI & Robotics Enthusiast | Tech Innovator</h3>
...
* 🤖 **Core Interests:** Deep diving into **Computer Vision** (Depth Estimation, 3D Representation), **Federated Learning**, and hardware programming (**ESP32 / Arduino**).
* 🚀 **Innovations:** Active participant in tech startup competitions and developer of driver behavior monitoring systems.
* 📚 **Learning Next:** Advanced Artificial Intelligence models and optimizing deployment on edge devices (Raspberry Pi/ONNX).
...
#### 🛡️ VISIONGUARD — Driver Behavior Monitoring System
* **Achievement:** Semi-finalist at **IT GOT TALENT 2025** and featured in *Mực Tím* magazine.
* **Tech Stack:** Python, Computer Vision, Embedded Hardware, ONNX deployment.
* **Description:** An intelligent system designed to monitor and analyze driver behavior in real-time to enhance road safety.
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/ONNX-005CEA?style=for-the-badge&logo=onnx&logoColor=white"/>
